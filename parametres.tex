...
% mettre les axiomes en boîte grise
\usepackage[many]{tcolorbox}
\newtheorem{axi}{Axiome}[section]
\tcolorboxenvironment{axi}{
  % colback=, % le gris clair est déjà la couleur par défaut
  boxrule=0pt,
  boxsep=0pt,
...
% remarque : les paramètres de numérotation spéciale des axiomes ont été définis dans le fichier "2-Angles.tex" afin de ne pas avoir les mêmes numéros d'axiomes dans différents chapitres.

% pour pas avoir le texte en italique
\theoremstyle{definition}
\newtheorem{rema}{Remarque}[section]
\newtheorem{exo}{Exercice}[section]
\newtheorem*{scheme}{Schème}
