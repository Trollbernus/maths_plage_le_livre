...
%\geometry{top=3.3cm, bottom=3.3cm, left=4cm , right=4cm} %plus simple que le suivant, que je ne maîtrise pas...
...
\usepackage{caption} %Moarf. Dans le doute je le garde.
%\usepackage{graphicx}
...
%    pdfnewwindow=true,      % links in new PDF window
    ...
    citebordercolor={darkgreen},        % color of links to bibliography
    filecolor={darkblue},      % color of file links
    filebordercolor={darkblue},      % color of file links
    urlcolor={xdxdff},           % color of external links
    urlbordercolor={xdxdff},           % color of external links
}
\fi
...
%Pour colorer les parenthèses des équations.
...
\newcommand{\guil}[1]{\og{} #1\fg} % entourer de guillemets
